...
{
    public class CriarHorarioAulaComandoValidador : AbstractValidator<CriarHorarioAulaComando>, IValidador<CriarHorarioAulaComando>
    {
        private readonly ITurnoRepositorio _turnoRepositorio;
        private readonly ICurriculoRepositorio _curriculoRepositorio;

        public CriarHorarioAulaComandoValidador(ITurnoRepositorio turnoRepositorio, ICurriculoRepositorio curriculoRepositorio)
        {
