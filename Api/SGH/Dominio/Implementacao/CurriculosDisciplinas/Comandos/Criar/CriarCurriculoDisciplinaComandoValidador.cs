...
{
    public class CriarCurriculoDisciplinaComandoValidador : AbstractValidator<CriarCurriculoDisciplinaComando>, ICriarCurriculoDisciplinaComandoValidador
    {
        private readonly ICurriculoDisciplinaRepositorio _curriculoDisciplinaRepositorio;
        private readonly IDisciplinaRepositorio _disciplinaRepositorio;

        public CriarCurriculoDisciplinaComandoValidador(ICurriculoDisciplinaRepositorio curriculoDisciplinaRepositorio, IDisciplinaRepositorio disciplinaRepositorio)
        {
