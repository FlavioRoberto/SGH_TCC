...
namespace SGH.Dominio.Extensions
{
    public static class InjecaoDependenciaExtension
    {
        public static IServiceCollection AddDominio(this IServiceCollection services)
        {
            ...
            services.AddTransient<IRemoverCursoComandoValidador, RemoverCursoComandoValidador>();
            services.AddTransient<ICriarProfessorComandoValidador, CriarProfessorComandoValidador>();
            #endregion
